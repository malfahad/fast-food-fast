...
class OrdersDB(DB):
    ...
    def insert_order(self,order_values):
        ...
        self.command = """ INSERT INTO Orders(order_id,items,orderedBy,status) VALUES (%(order_id)s,%(items)s,%(orderedBy)s,%(status)s); """
        self.execute()
...
class MenuDB(DB):
    ...
    def insert_menu_item(self,menu_item_values):
        ...
        self.command = """ INSERT INTO Menu(id,title,description,image_url) VALUES (%(id)s,%(title)s,%(description)s,%(image_url)s); """
        self.execute()
    def get_menu_item(self,menu_id):
        self.values = {'menu_id':menu_id};
        self.command = """ SELECT * FROM Orders WHERE id=%(menu_id)s ; """
        self.execute('SELECT')
    def get_menu(self):
    ...
    def delete_menu_item(self,menu_id):
        self.values = {'menu_id':menu_id};
        self.command = """ DELETE FROM Menu WHERE id=%(menu_id)s ; """
        self.execute('DELETE')
